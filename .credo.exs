  ...
  configs: [
    %{
      ...
      files: %{
        ...
        excluded: [~r"/_build/", ~r"/deps/", ~r"/node_modules/", ~r"lib/http_cookie/date_parser.ex$"]
      },
      #
      ...
      checks: %{
        enabled: [
          ...
          ## ex_slop
          #
          # The ExSlop plugin's auto-enabled checks are dropped when this file
          # defines an explicit `enabled:` list, so they are listed here.
